...
legend('\gamma = 1.5','\gamma = 5','\gamma = 1.5, \mu = q_{20}',...
...
print(gcf,'-depsc2','-loose',strcat('data/tsm/state'));
clear s s2 s3 Fs gamma
...
for vv = 1:size(data,2)
    ...
    set(gca,'FontSize',12)
    set(gcf,'paperpositionmode','auto')
    print(gcf,'-depsc2','-loose',strcat('data/tsm/',labels{vv}));
end
